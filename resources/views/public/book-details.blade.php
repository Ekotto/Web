                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="book-price mb-2">
                                            ...
                                            @if($book->discount_rate)
                                                <span></span><strong class="line-through">{{$book->init_price}} FCFA</strong>
                                            @endif
                                                <span>now</span><strong> {{$book->price}} FCFA</strong>
                                            @if($book->discount_rate)
                                                <div><strong class="text-danger">Save {{$book->init_price - $book->price}} FCFA</strong></div>
                                            @endif
                                        </div>
