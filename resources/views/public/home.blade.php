            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption">
                        ...
                        <p class="d-none d-md-block"><strong>Reading is fascinating.</strong></p>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        ...
                        <p class="d-none d-md-block"><strong>Have a look and be pleased.</strong></p>
                    </div>
                </div>
                <div class="carousel-item">
                                            ...
                                            <div class="col-lg-3 col-6">
                                                <div class="book-wrap">
                                                    ...
                                                    <div class="pbook-price mb-3">
                                                        @if($book->discount_rate)
                                                            <span class="line-through mr-3">{{$book->init_price}} FCFA</span>
                                                        @endif
                                                        <span class=""><strong>{{$book->price}} FCFA</strong></span>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
